...
<ul class="btn_top top btn_bo_user"> 
    <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn-outline-dark" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</a></li><?php } ?>
	
	<li>
		<button type="button" class="btn_more_opt btn_b03 btn btn-outline-dark is_view_btn" title="게시판 리스트 옵션"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 리스트 옵션</span></button>
    	<?php ob_start(); ?>
	    <ul class="more_opt is_view_btn">
	    	...
	    	<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a></li><?php } ?>
        ...
        <div id="bo_v_con">
            <section class="shopStyleWrap">
                <?php
                    ...
                    //$curlReturn = $barryUtil -> getCurlGnuLinkImage('https://www.youtube.com/watch?v=mxJGDa7ThbE');
                    //var_dump($curlReturn);
                    //echo('<img src="'.$curlReturn.'" width="600" height="600">');
                ?>
                ...
                <div class="shopStyleInfo">
                    ...
                    <ul class="command">
                        ...
                        ?>
                                <li>
                                    <a href="<?php echo $view['link_href'][$i] ?>" class="btn btn-info"><?php echo $i ?>번 링크 보기</a>
<!--                                    <p><i class="fa fa-link" aria-hidden="true"></i>--><?php //echo $link ?><!--</p>-->
<!--                                    <p>--><?php //echo $view['link_hit'][$i] ?><!--회 연결</p>-->
                                </li>
                            <?php endif; ?>
                        <?php endfor; ?>
                    </ul>
                ...
                <div class="shopStyleWriterInfo">
                    ...
                    <p><span class="seller_name"><?php echo $view['wr_name'] ?></span>/<span class="sellet_phone"><?php echo $view['mb_id'] ?></span></p>
                </div>
            </section>
                ...
                <section class="linkArea">
                    ...
                    ?>
                        <a href="<?php echo $view['link_href'][$i] ?>">
                            <div class="media">
                                <div class="align-self-center mr-3" style="flex: 0 0 130px; width: 130px; height: 100px;">
                                    <svg width="130" height="100" viewBox="0 0 130 100" fill="">
                                        <path fill="#FF0000" d="M118.9 13.5c-1.4-5.2-5.5-9.3-10.7-10.7C98.7.3 60.7.3 60.7.3s-38 0-47.5 2.5C8 4.2 3.9 8.3 2.5 13.5 0 23 0 42.7 0 42.7s0 19.8 2.5 29.2c1.4 5.2 5.5 9.3 10.7 10.7 9.5 2.5 47.5 2.5 47.5 2.5s38 0 47.5-2.5c5.2-1.4 9.3-5.5 10.7-10.7 2.5-9.5 2.5-29.2 2.5-29.2s0-19.7-2.5-29.2z"></path><path fill="#FFF" d="M48.5 61l31.6-18.2-31.6-18.3z"></path>
                                    </svg>
                                </div>
                                <div class="media-body">
                                    <h5 class="mt-0"><?php echo cut_str(get_text($view['wr_subject']), 70);?></h5>
