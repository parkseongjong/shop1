...
add_javascript('<script src="'.$member_skin_url.'/seller/memberOrderList.js"></script>', 1);
                    ...
                    <li>
                        ...
                        >
                            <div class="row no-gutters">
                                ...
                                <div class="col-8" onclick="goDetail('<?php echo $memberOrderList[$i]['wr_id']; ?>')">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                        ...
                                        <section class="info">
                                            <ul class="contents left">
                                                ...
                                                <li class="flex-column mt-1 mb-1">
                                                    <?php if ($memberOrderList[$i]['wr_status'] =='order'): ?>
                                                        <span class="btn btn-dark btn-block" onclick="goDelivery('<?php echo $memberOrderList[$i]['wr_id']; ?>')">배송시작으로 변경</span>
                                                    <?php elseif ($memberOrderList[$i]['wr_status'] =='delivery'): ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <span class="btn btn-warning btn-block" onclick="goCancelDelivery('<?php echo $memberOrderList[$i]['wr_id']; ?>')">배송 취소로 변경</span>
                                                    <?php endif; ?>
                                                </li>
                                                <li class="flex-column mt-1 mb-1">
                                                    <span class="btn btn-info btn-block" onclick="goDetail('<?php echo $memberOrderList[$i]['wr_id']; ?>')">상세 정보 보기</span>
                                                </li>
                                            </ul>
                                        </section>
                                    </div>
