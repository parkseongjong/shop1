...
//베리몰 테마 상수 정의
define('BARRY_THEME_CUSTOM_PATH' , G5_THEME_PATH);
define('BARRY_THEME_CUSTOM_URL' , G5_THEME_URL);

define('BARRY_THEME_CUSTOM_PC_CSS_PATH' , G5_THEME_PATH.'/css');
define('BARRY_THEME_CUSTOM_PC_CSS_URL' , G5_THEME_URL.'/css');
define('BARRY_THEME_CUSTOM_PC_JS_PATH' , G5_THEME_PATH.'/js');
define('BARRY_THEME_CUSTOM_PC_JS_URL' , G5_THEME_URL.'/js');
define('BARRY_THEME_CUSTOM_PC_IMG_PATH' , G5_THEME_PATH.'/img');
define('BARRY_THEME_CUSTOM_PC_IMG_URL' , G5_THEME_URL.'/img');

define('BARRY_THEME_CUSTOM_MOBILE_CSS_PATH' , G5_THEME_PATH.'/mobile/css');
define('BARRY_THEME_CUSTOM_MOBILE_CSS_URL' , G5_THEME_URL.'/mobile/css');
define('BARRY_THEME_CUSTOM_MOBILE_JS_PATH' , G5_THEME_PATH.'/mobile/js');
define('BARRY_THEME_CUSTOM_MOBILE_JS_URL' , G5_THEME_URL.'/mobile/js');
define('BARRY_THEME_CUSTOM_MOBILE_IMG_PATH' , G5_THEME_PATH.'/mobile/img');
define('BARRY_THEME_CUSTOM_MOBILE_IMG_URL' , G5_THEME_URL.'/mobile/img');
