...
define('G5_MYSQL_USER', 'onefamily11');
define('G5_MYSQL_PASSWORD', '1234');
define('G5_MYSQL_DB', 'onefamily11');
define('G5_MYSQL_SET_MODE', true);

//define('G5_CYBERTRON_HOST', '175.126.82.225');
//define('G5_CYBERTRON_USER', 'web3_cybertron');
//define('G5_CYBERTRON_PASSWORD', 'web@1387251!abeieh123#ieh');
//define('G5_CYBERTRON_DB', 'wallet');
