...
*/
define('G5_DOMAIN', 'https://barrybarries.kr');
define('G5_HTTPS_DOMAIN', 'https://barrybarries.kr');
...
*/
define('G5_COOKIE_DOMAIN',  '.barrybarries.kr');
...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') {   //https 통신일때 daum 주소 js
    ...
    define('G5_POSTCODE_JS', '<script src="http://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>');
}
?>