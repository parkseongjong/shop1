...
if (!$member['mb_id'])
{
    alert('로그인 하십시오.', G5_URL.'/adm/barryAdminLogin.php?url=' . urlencode(correct_goto_url(G5_ADMIN_URL)));
}
else if ($is_admin != 'super')
{
        
    $onefamilyCorpSeller = array('0260911125','0260911126','0260911127','02609111258','0260911129');
    if(in_array($member['mb_id'],$onefamilyCorpSeller)){
        goto_url(G5_URL);
    }
    $auth = array();
