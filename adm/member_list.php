...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        <td headers="mb_list_chk" class="td_chk" rowspan="3">
        ...
        <td headers="mb_list_mng" rowspan="3" class="td_mng td_mng_s"><?php echo $s_mod ?><?php echo $s_grp ?></td>
    </tr>
    <tr class="<?php echo $bg; ?>">
        <td headers="mb_list_name" rowspan="2" class="td_mbname"><?php echo get_text($row['mb_name']); ?></td>
        <td headers="mb_list_nick" rowspan="2" class="td_name sv_use"><div><?php echo $mb_nick ?></div></td>
    ...
    <tr class="<?php echo $bg; ?>">
        <td headers="mb_list_name" class="td_mbname">관리자지갑주소</td>
        <td headers="mb_list_name" colspan="7" class="td_mbname"><?php echo get_text($row['mb_1']); ?></td>
    </tr>
