            ...
            <form id="integrationMobileAppViewForm" method="post" enctype="multipart/form-data" v-for="(data, dataIndex) in integrationList" v-bind:key="data.id">
                ...
                <section class="info">
                    ...
                    <ul class="contents left">
                        ...
                        <li>
                            <h4>카드 주문 번호</h4>
                            <span>{{data.itemOrderNumber}}</span>
                        </li>
                        <li>
                            <h4>주문 일시</h4>
                        ...
                        <li>
                            <h4>결제수단</h4>
                            <span>{{data.paymentType}} ({{data.cardResponse}})</span>
                        </li>
                        ...
                        <li>
                            <h4>상품 판매 상태</h4>
                            <span v-if="data.itemUse == 'N'">
                                <span class="badge badge-success">판매중</span>
                            </span>
                            <span v-if="data.itemUse == 'Y'">
                                <span class="badge badge-danger">판매 일시 중지</span>
                            </span>
                        </li>
                        <li>
                            <h4>상품 품절 여부</h4>
                            <span v-if="data.itemSoldout == '0'">
                                <span class="badge badge-success">정상</span>
                            </span>
                            <span v-if="data.itemSoldout == '1'">
                ...
                <section class="info" >
                    ...
                    <ul class="contents left">
                        <li>
							...
							<span v-else-if="data.paymentStatus == 'deferredPayment'">
                        ...
                        <li v-if="data.paymentRealType == 'CREDITCARD'">
                            <h4>승인 번호</h4>
                            <span v-if="data.itemOrderAuthNumber == false">
                                승인 번호가 없습니다.
                            </span>
                            <span v-else>
                                {{data.itemOrderAuthNumber}}
                            </span>
                        </li>
                        <li>
                            <span class="btn btn-primary btn-block" v-on:click="paymentModalShow()" v-if="(data.paymentStatus != 'completePayment' && data.paymentRealType != 'KRW')">결제</span>
                        </li>
                    </ul>
                </section>
