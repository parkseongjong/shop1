...
<div id="mb_login" class="mbskin" style="font-size: 1.3em;">
    ...
    <div id="login_frm">
        <label for="login_id" class="sound_only">전화번호<strong class="sound_only"> 필수</strong></label>
        <input type="text" name="mb_id" id="login_id" placeholder="전화번호" required class="frm_input required" maxLength="20">
    ...
    <section class="mb_login_join">
        <h2>회원로그인 안내</h2>
        <div>
            <a href="./password_lost.php">회원정보찾기</a>
    ...
    <style type="text/css">
    .desc2 {padding:25px 30px 0 30px; margin:0 20px;font-size:15px;color:#777;text-align:center;margin-top:15px; border-top:1px solid #ccc;}
    .mbskin p {padding:30px 27px 45px 0; font-size:15px; margin:0 20px;}
    </style>


    <div class="desc2">
        * 아이디를 모르시거나 지갑 회원이신분은 아래 버튼을 클릭하신후 CTC 지갑에서 로그인하시면 쇼핑몰에 로그인 됩니다.<br />
    </div>
    <div class="mbskin">
        <p>
