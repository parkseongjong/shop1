    ...
    if ($row) {
        ...
        while ($row = sql_fetch_array($result)) {
            ...
            if ($row['me_write_mb_id']==$mb_id) {   // 내가 쓴글
                ...
                echo "<div class='target'><ul><li class='img'><img src='/img/no_profile.gif' alt='profile_image' /></li><li class='sym'>&nbsp;</li><li class='desc'>".$row['me_memo']."</li><li class='dt'>{$apm}<br />{$whour}:{$wmin}</li></ul></div>";
            }
        }
    }
?>
...
<div id="input_section">
    <ul>
        ...
        <li class="img">
            <img src="/img/mobile/send_message.png" onclick="sendMemo()" />
        </li>
    </ul>
</div>
