...
<a  href='<?php echo $board_skin_url; ?>order/excel.php?bo_table=order' class="btn_admin btn2" target='_blank'><i class="fa fa-user-circle" aria-hidden="true"></i> 주문 리스트 Excel 다운로드</a>
